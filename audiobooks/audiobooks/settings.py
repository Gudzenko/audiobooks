...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-testtesttesttesttesttesttesttesttesttesttesttestte')
...
CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'http://192.168.34.6').split(',')
